...
WeChat.prototype.auth = function(req,res){
    ...
    /*this.getAccessToken().then(function(data){
	   //格式化请求连接
	   var url = util.format(that.apiURL.createMenu,that.domain,data);
       //使用 Post 请求创建微信菜单
...
WeChat.prototype.getAccessToken = function(){
    ...
    return new Promise(function(resolve,reject){
        ...
        //格式化请求地址
        var url = util.format(that.apiURL.accessTokenApi,that.domain,that.appID,that.appScrect);
        console.log('========',url);
